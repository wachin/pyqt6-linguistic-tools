"""Minimal QPlainTextEdit integration with spell checking and highlighting.

Usage:
    python examples/basic_qplaintextedit.py
    LIBREOFFICE_DICTIONARIES_PATH=/path/to/dicts python examples/basic_qplaintextedit.py
"""
...
from PyQt6.QtWidgets import QApplication, QMainWindow, QPlainTextEdit  # noqa: E402
...
def main() -> int:
    ...
    app.setApplicationName("LinguisticTools QPlainTextEdit Example")
    ...
    window.setWindowTitle(
        f"QPlainTextEdit — {service.available_languages()[0] if service.available_languages() else language}"
    )
